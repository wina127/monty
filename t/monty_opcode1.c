...
/**
* op_sub - this subtracts the top first nodes elt n from the second's.
* @stack: address of the top pointer of the stack.
* @line_number: The line number of the opcode in the file.
*/
...
/**
* op_div - this divides the second top element of the stack by the top
...
/**
* op_mul - this multiplies the top two elements of the stack.
* @stack: the address of the top pointer of the stack.
* @line_number: The line number of the opcode in the file.
*/

...
/**
* exit_error_msg - this exits the program after print the error message
...
/**
* free_exit - this exits the program after freeing memories retrieved
* dynamically.
* @_exit: status you want to exit with.
*/
...
/**
* level_one_error - thhis prints error messages for early errors.
* @code: error code
* @add: anny additional info to the error.
*/
...
/**
* level_two_error - this prints error message for late errors.
* @code: error code.
* @add: any additonal information about the error.
*/
